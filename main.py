...
#         insert_query = sql.SQL('''
#             INSERT INTO public.clients (id, email, password, created_at, updated_at, remember_me_token, failed_attempts, account_locked)
...
#         insert_values = (client_id, client.email, hashed_password, created_at, updated_at, client.remember_me, 0, False)
